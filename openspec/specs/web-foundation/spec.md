...
Define the base public web identity for the Zenlift landing page, including project identity, metadata, navigation, footer, and placeholder download calls to action.
