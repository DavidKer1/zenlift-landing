...
function WorkoutMockup() {
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto hidden h-[520px] max-w-6xl opacity-70 md:block">
      ...
      <div className="absolute left-10 top-52 w-72 rounded-lg border border-zinc-800/70 bg-zinc-950/80 p-4 shadow-2xl shadow-black/40">
      ...
      <div className="absolute right-8 top-40 w-[300px] rounded-[2rem] border border-zinc-800 bg-zinc-950 p-3 shadow-2xl shadow-black/50">
...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[880px] flex-col items-center justify-center overflow-hidden px-6 pb-20 pt-24">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        <div className="mt-16 grid grid-cols-1 gap-3 text-left sm:grid-cols-3 md:hidden">
          {[
